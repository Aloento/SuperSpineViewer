...
public class SimpleTest extends ApplicationAdapter {
	...
	public void create () {
		...
		binary.setScale(0.6f); // Load the skeleton at 60% the size it was in Spine.
		SkeletonData skeletonData = binary.readSkeletonData(Gdx.files.internal("spineboy/spineboy-pro.skel"));
